    ...
    <>
      ...
      >
          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div ref={linksRef} className="hidden md:flex items-center space-x-8">
              {navigation.map((item) => (
                ...
                >
                  {item.name}
                  <span className="absolute bottom-0 left-0 w-full h-0.5 bg-current scale-x-0 group-hover:scale-x-100 transition-transform duration-200" />
                </button>
              ))}
            </div>
        ...
        <div 
          ref={mobileMenuRef}
          className={cn(
            "md:hidden px-2 pt-2 pb-3 space-y-1 backdrop-blur-sm",
